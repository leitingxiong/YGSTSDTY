...
/// </summary>
[CustomPropertyDrawer(typeof(MaximalAttribute))]
public class MaximalAttributeDrawer : PropertyDrawer
{
    /// <summary>
    ...
    {
        MaximalAttribute targetAttribute = attribute as MaximalAttribute;
        ...
        switch (property.propertyType)
        {
            ...
            case SerializedPropertyType.Float:
                ...
                if (floatValue <= targetAttribute.MaxValue)
            ...
            case SerializedPropertyType.Vector2:
                ...
                if (vec2Value.Vector2AGreaterThanB(targetAttribute.VectorMaxValue, targetAttribute.UseAndOperate))
                {
                    if (targetAttribute.ShowTips)
                        EditorUtility.DisplayDialog("提示", $"Vector2变量：{label.text}\n值大于设定的最小值{targetAttribute.VectorMaxValue}", "确定");
                    break;
                }
            ...
            case SerializedPropertyType.Vector3:
                ...
                if (vec3Value.Vector3AGreaterThanB(targetAttribute.VectorMaxValue, targetAttribute.UseAndOperate))
                {
                    if (targetAttribute.ShowTips)
            ...
            case SerializedPropertyType.Vector4:
                ...
                if (vec4Value.Vector4AGreaterThanB(targetAttribute.VectorMaxValue, targetAttribute.UseAndOperate)) 
                {
                    if(targetAttribute.ShowTips)
